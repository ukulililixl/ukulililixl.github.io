...
\section{Selected Projects}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Source: https://http://adslab.cse.cuhk.edu.hk/software/ecpipe/} {}
      \resumeItemListStart
...
%-----------Teaching------------------
 \section{Teaching}
  \resumeSubHeadingListStart
    \resumeSubItem{Operating System}{2016 Fall}
    \resumeSubItem{Introduction to Cloud Computing and Storage}{2017 Fall, 2018 Fall}
    \resumeSubItem{Data Communication and Computer Networks}{2018 Spring}
  \resumeSubHeadingListEnd
