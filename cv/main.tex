...
\section{Selected Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading
      {OpenEC}{Aug. 2017 - Now}
      \resumeItemListStart
        \resumeItem{}{OpenEC is a new erasure coding management system that easily runs atop multiple distributed storage systems to manage erasure-coded data. It presents simple programming model for erasure coding designers to design new codes. It also provides general storage system interfaces for integration.}
