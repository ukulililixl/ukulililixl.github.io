...
\section{Selected Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading
      {OpenEC}{Aug. 2017 - Now}
      \resumeItemListStart
        \resumeItem{}{OpenEC is a new erasure coding management system that easily runs atop multiple distributed storage systems to manage erasure-coded data. It presents simple programming model for erasure coding designers to design new codes. It also provides general storage system interfaces for integration. OpenEC takes over all erasure coding operations for both sides.}
	\resumeItem{}{I build the system OpenEC to provide previous features for storage system developers and code designers.}
        %\resumeItem{}{We are building a new erasure coding system which can easily run atop multiple distributed storage systems to manage erasure-coded data. On the one hand, we make it easier for erasure coding designers to design a new code using our new programming abstraction. On the other hand, we make it easier for system developers to apply new erasure codes into their system without much kernel modifications.}
      \resumeItemListEnd
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Distributed Systems:}{Hadoop. OpenStack Swift.}
